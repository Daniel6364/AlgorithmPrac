...
* 각 마을로부터 음식 주문을 받으려고 하는데, N개의 마을 중에서 K 시간 이하로 배달이 가능한 마을에서만
* 주문을 받으려고 합니다. 다음은 N = 5, K = 3인 경우의 예시입니다.
...
a, b(1 ≤ a, b ≤ N, a != b)는 도로가 연결하는 두 마을의 번호이며, c(1 ≤ c ≤ 10,000, c는 자연수)는
* 도로를 지나는데 걸리는 시간입니다.
*
