 ...
 * : java로 코딩테스트를 봤으며, backend 직군을 선택했고 junior 경력이면서 소울푸드로 pizza를 선택한 지원자 중 코딩테스트 점수를 100점
 * 이상 받은 지원자는 1명 입니다.
 * <p>
 * "python and frontend and senior and chicken 200"
 * : python으로 코딩테스트를 봤으며, frontend 직군을 선택했고, senior 경력이면서 소울 푸드로 chicken을 선택한 지원자 중 코딩테스트 점수를 200점
 * 이상 받은 지원자는 1명 입니다.
 * <p>
...
//                System.out.println(j + " queryTmp : " + queryTmp[j]);
//                System.out.println(j + " infoTmp : " + infoTmp[j]);
        ...
        for (ArrayList<String> queryVal : queryList) {
            for (int i = 0; i < queryVal.size(); i++) {

                System.out.println(i + "queryVal : " + queryVal.get(i));
...
//
//        for (ArrayList<String> value : queryList) {
//            System.out.println("==// queryList : " + value);
//        }
//
//        System.out.println("\n===================//");
//
//        for (ArrayList<String> value : infoList) {
//            System.out.println("==// infoList : " + value);
//        }

        return answer;
    }

    public static int compareScore(int infoScore, int queryScore) {
