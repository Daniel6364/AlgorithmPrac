...
public class SameCard {
    ...
    public static int solution(int[][] board, int r, int c) {
        ...
        // 1. 배열에서 커서의 위치를 뽑아내고
        // 2. 뽑아낸 커서 위치에 카드가 있는지 확인
        // 3. 있으면 거기부터 시작
        // 4. 없으면 커서의 위치와 가장 가까운 카드 위치로 찾기
        ...
        for (int row = 0; row < board.length; row++) {
            for (int line = 0; line < board[row].length; line++) {
                ...
                int cursor = board[c][r];
                int card = board[row][line];
    ...
    public static void main(String[] args) {
        ...
        int[][] board = {{3,0,0,2},{0,0,1,0},{0,1,0,0},{2,0,0,3}}; // 카드판 배열
        int r = 0; // 커서의 처음 위치 세로
        int c = 0; // 커서의 처음 위치 가로
