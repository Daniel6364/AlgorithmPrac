 ...
 * @package_name com.algorithm.prac.programmers.controller.first
 * @since 2021-04-01
 *
 * 실패율
 * 문제 설명
 ...
 * 배열 stages가 매개변수로 주어질 때, 실패율이 높은 스테이지부터 내림차순으로 스테이지의 번호가 담겨있는 배열을
...
public class FailureRatio {
    ...
    public static void main(String[] args) {
        ...
        //double value = 1; double total = 8;
        //System.out.println(value / total * 100);
